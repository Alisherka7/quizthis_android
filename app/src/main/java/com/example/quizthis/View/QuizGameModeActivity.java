...
public class QuizGameModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_game_mode);
...
// Create the title TextView
                        ...
                        if(sets.getItems() < 4){
                            titleTextView.setText( sets.getTitle() + "\n Please add at least 4 questions");
                        }else{
                            titleTextView.setText(sets.getTitle());
                        }
                        ...
                        if(sets.getItems() >= 4){
                            parentLayout.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Intent intent = new Intent(getApplication(), StartQuizGameActivity.class);
                    ...
                    Intent intent = new Intent(QuizGameModeActivity.this, AuthenticationActivity.class);
                    startActivity(intent);
                    finish();
                }
            }
